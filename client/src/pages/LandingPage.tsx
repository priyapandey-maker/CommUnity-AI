...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-surface transition-colors duration-200">
      ...
      {/* Hero */}
      <main className="flex-1 flex flex-col items-center justify-center mx-auto max-w-6xl px-6 pt-16 pb-12 w-full">
        <div className="text-center max-w-2xl">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold tracking-tight leading-tight mb-4 text-primary">
            Public Incident Resolution &{' '}
            <span className="text-primary-600 dark:text-primary-400">Decision Register</span>
          </h1>

          <p className="text-base max-w-xl mx-auto mb-8 leading-relaxed text-secondary">
          ...
          <div className="mt-8 flex items-center justify-center gap-2 text-[11px] text-muted font-medium border-t border-line/45 pt-5">
          ...
          <div className="mt-14 grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
            {FEATURES.map(({ icon, iconColor, iconBg, title, desc }) => (
              <div
                key={title}
                className="rounded-xl p-6 border border-line bg-surface-1 shadow-card dark:shadow-card-dark transition-colors duration-150"
              >
                <span
                ...
                <h2 className="text-xs font-semibold mb-2 text-primary uppercase tracking-wider">
                  {title}
                </h2>
